  ...
  module Visitors
    class EvaluationVisitor < Visitor
      ...
      def visit_SubtractNode(o)
        RBelly::JS::Property.new(:subtract,
      ...
      def visit_MultiplyNode(o)
        ...
        return_val = 
          if [left, right].any? { |x| x.respond_to?(:nan?) && x.nan? }
            ...
            } ? RBelly::JS::NaN.new : left * right
          end
        RBelly::JS::Property.new(:multiple, return_val)
      end
      ...
      def visit_DivideNode(o)
        ...
        RBelly::JS::Property.new(:divide, return_val)
      end
      ...
      def visit_NumberNode(o)
        RBelly::JS::Property.new(o.value, o.value)
      end

      def visit_VoidNode(o)
        o.value.accept(self)
        RBelly::JS::Property.new(:undefined, :undefined)
      end

      def visit_NullNode(o)
        RBelly::JS::Property.new(nil, nil)
      end

      def visit_TrueNode(o)
        RBelly::JS::Property.new(true, true)
      end

      def visit_FalseNode(o)
        RBelly::JS::Property.new(false, false)
      end

      def visit_StringNode(o)
        RBelly::JS::Property.new(:string,
          o.value.gsub(/\A['"]/, '').gsub(/['"]$/, '')
        )
      end
      ...
      def visit_EqualNode(o)
        ...
        RBelly::JS::Property.new(:equal_node, left.value == right.value)
      end
      ...
      def visit_BitwiseNotNode(o)
        ...
        RBelly::JS::Property.new(nil, ~number.value)
      end
      ...
      def visit_TypeOfNode(o)
        ...
        return RBelly::JS::Property.new(:string, 'object') if val.value.nil?

        case val.value
        when String
          RBelly::JS::Property.new(:string, 'string')
        when Numeric
          RBelly::JS::Property.new(:string, 'number')
        when true
          RBelly::JS::Property.new(:string, 'boolean')
        when false
          RBelly::JS::Property.new(:string, 'boolean')
        when :undefined
          RBelly::JS::Property.new(:string, 'undefined')
        else
          RBelly::JS::Property.new(:object, 'object')
        end
      end
      ...
      def to_number(object)
        return RBelly::JS::Property.new('0', 0) unless object.value
        ...
        RBelly::JS::Property.new(nil, return_val)
      end

      def to_boolean(object)
        return RBelly::JS::Property.new(false, false) unless object.value
        value = object.value
        boolean =
          case value
          when :undefined
        ...
        RBelly::JS::Property.new(boolean, boolean)
      end
      ...
      def to_int_32(object)
        ...
        if value.respond_to?(:nan?) && (value.nan? || value.infinite?)
          RBelly::JS::Property.new(nil, 0)
        end
        value = ((value < 0 ? -1 : 1) * value.abs.floor) % (2 ** 32)
        if value >= 2 ** 31
          RBelly::JS::Property.new(nil, value - (2 ** 32))
        else
          RBelly::JS::Property.new(nil, value)
        end
      end
      ...
      def to_primitive(object, preferred_type = nil)
        ...
        when false, true, :undefined, ::String, Numeric
          RBelly::JS::Property.new(nil, object.value)
        when RBelly::JS::Base
